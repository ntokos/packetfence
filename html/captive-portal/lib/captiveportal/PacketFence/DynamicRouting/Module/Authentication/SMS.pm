...
has '+source' => (
    isa => 'pf::Authentication::Source::SMSSource|pf::Authentication::Source::TwilioSource|pf::Authentication::Source::ClickatellSource|pf::Authentication::Source::SMSGUNetSource',
    lazy => 1,
